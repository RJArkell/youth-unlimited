...
/* harmony import */ var _partials_featureDetection__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var lax_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5);
/* harmony import */ var lax_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(lax_js__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var xwiper__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6);
/* harmony import */ var xwiper__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(xwiper__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var bootstrap_js_src_collapse__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(7);





    var bodyScrollLock = __webpack_require__(4);
    ...
    jquery__WEBPACK_IMPORTED_MODULE_1___default()(function ($) {
      ...
      $(document).on('focusin', 'html:not(.overlay-shown) .overlay *', showOverlay).on('focusout', 'html.overlay-shown .overlay *', hideOverlay); //
      // Parallax
      //

      lax_js__WEBPACK_IMPORTED_MODULE_2___default.a.addPreset('backdrop', function () {
        return {
          'data-lax-translate-y': '(vh) -90, (-elh) 60'
        };
      });
      lax_js__WEBPACK_IMPORTED_MODULE_2___default.a.setup({
        breakpoints: {
          small: 0,
          large: 768
        }
      ...
      var widthChangeHandlers = [];
      var heightChangeHandlers = [lax_js__WEBPACK_IMPORTED_MODULE_2___default.a.updateElements];

      var repaint = function repaint() {
        if (docHeight != document.body.scrollHeight) {
          heightChangeHandlers.forEach(function (val) {
            return val();
          });
        ...
        if (docWidth != window.innerWidth) {
          widthChangeHandlers.forEach(function (val) {
            return val();
          });
          docWidth = window.innerWidth;
        }

        lax_js__WEBPACK_IMPORTED_MODULE_2___default.a.update(window.scrollY);
      ...
      $('.carousel').each(function (index, el) {
        var $carousel = $(el);
        var $slideWrap = $carousel.find('.slides');
        var $slidesNext = $carousel.find('.slides-next');
        var $slides = $slideWrap.find('.slide');
        var $prev = $carousel.find('.btn-prev');
        var $next = $carousel.find('.btn-next'); // Fired on all slide changes.

        var update = function update(activeIndex, $active) {
          if (!$active) {
          ...
          var newLeft = activeIndex === 0 ? '0' : $slidesNext.offset().left - $active.offset().left - $active[0].offsetWidth;
          $slideWrap.css({
            transform: "translateX(".concat(newLeft, "px)")
          }); // Update counter.

          $carousel.find('.counter-current').text(activeIndex + 1); // Enable/disable navigation buttons.
        ...
        var nextSlide = function nextSlide() {
          var $active = $carousel.find('.slide-active');
          var activeIndex = $slides.index($active); // Do nothing if last slide.
        ...
        var prevSlide = function prevSlide() {
          var $active = $carousel.find('.slide-active');
          var activeIndex = $slides.index($active); // Do nothing if first slide.
        ...
        $carousel.on('click', '.btn-next:enabled', nextSlide).on('click', '.btn-prev:enabled', prevSlide); // Add support for swipe on touch devices.

        var xwiper = new xwiper__WEBPACK_IMPORTED_MODULE_3___default.a(el);
      ...
      $('.needs-validation').on('submit', function (e) {
        ...
        $form.removeClass('was-validated form-success form-error').addClass('form-busy').find('[type="submit"]').prop('disabled', true); // Post form to AJAX.

        $.post($form.attr('action'), $form.serialize()).always(function (data) {
          if ('error' === data.status) {
            $form.addClass('form-error').find('.msg-error p.text-danger').text(data.message);
          } else {
            $form.addClass('form-success');
            e.target.reset();
          }

          $form.removeClass('form-busy').find('[type="submit"]').prop('disabled', false);
        });
        return false;
      });
    });
...
/***/ (function (module, __webpack_exports__, __webpack_require__) {
    ...
    "use strict";
    __webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function () { return featureDetection; });
...
/***/ (function (module, exports, __webpack_require__) {
    ...
    "use strict";
    function _objectSpread(a) { for (var b = 1; b < arguments.length; b++) { var c = null == arguments[b] ? {} : arguments[b], d = Object.keys(c); "function" == typeof Object.getOwnPropertySymbols && (d = d.concat(Object.getOwnPropertySymbols(c).filter(function (a) { return Object.getOwnPropertyDescriptor(c, a).enumerable }))), d.forEach(function (b) { _defineProperty(a, b, c[b]) }) } return a } function _defineProperty(a, b, c) { return b in a ? Object.defineProperty(a, b, { value: c, enumerable: !0, configurable: !0, writable: !0 }) : a[b] = c, a } function _classCallCheck(a, b) { if (!(a instanceof b)) throw new TypeError("Cannot call a class as a function") } function _defineProperties(a, b) { for (var c, d = 0; d < b.length; d++)c = b[d], c.enumerable = c.enumerable || !1, c.configurable = !0, "value" in c && (c.writable = !0), Object.defineProperty(a, c.key, c) } function _createClass(a, b, c) { return b && _defineProperties(a.prototype, b), c && _defineProperties(a, c), a } var defaults = { threshold: 50, passive: !1 }, Xwiper = function () { function a(b) { var c = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {}; _classCallCheck(this, a), this.options = _objectSpread({}, defaults, c), this.element = null, this.touchStartX = 0, this.touchStartY = 0, this.touchEndX = 0, this.touchEndY = 0, this.onSwipeLeftAgent = null, this.onSwipeRightAgent = null, this.onSwipeUpAgent = null, this.onSwipeDownAgent = null, this.onTapAgent = null, this.onTouchStart = this.onTouchStart.bind(this), this.onTouchEnd = this.onTouchEnd.bind(this), this.onSwipeLeft = this.onSwipeLeft.bind(this), this.onSwipeRight = this.onSwipeRight.bind(this), this.onSwipeUp = this.onSwipeUp.bind(this), this.onSwipeDown = this.onSwipeDown.bind(this), this.onTap = this.onTap.bind(this), this.destroy = this.destroy.bind(this), this.handleGesture = this.handleGesture.bind(this); var d = !!this.options.passive && { passive: !0 }; this.element = b instanceof EventTarget ? b : document.querySelector(b), this.element.addEventListener("touchstart", this.onTouchStart, d), this.element.addEventListener("touchend", this.onTouchEnd, d) } return _createClass(a, [{ key: "onTouchStart", value: function b(a) { this.touchStartX = a.changedTouches[0].screenX, this.touchStartY = a.changedTouches[0].screenY } }, { key: "onTouchEnd", value: function b(a) { this.touchEndX = a.changedTouches[0].screenX, this.touchEndY = a.changedTouches[0].screenY, this.handleGesture() } }, { key: "onSwipeLeft", value: function b(a) { this.onSwipeLeftAgent = a } }, { key: "onSwipeRight", value: function b(a) { this.onSwipeRightAgent = a } }, { key: "onSwipeUp", value: function b(a) { this.onSwipeUpAgent = a } }, { key: "onSwipeDown", value: function b(a) { this.onSwipeDownAgent = a } }, { key: "onTap", value: function b(a) { this.onTapAgent = a } }, { key: "destroy", value: function a() { this.element.removeEventListener("touchstart", this.onTouchStart), this.element.removeEventListener("touchend", this.onTouchEnd) } }, { key: "handleGesture", value: function a() { return this.touchEndX + this.options.threshold <= this.touchStartX ? (this.onSwipeLeftAgent && this.onSwipeLeftAgent(), "swiped left") : this.touchEndX - this.options.threshold >= this.touchStartX ? (this.onSwipeRightAgent && this.onSwipeRightAgent(), "swiped right") : this.touchEndY + this.options.threshold <= this.touchStartY ? (this.onSwipeUpAgent && this.onSwipeUpAgent(), "swiped up") : this.touchEndY - this.options.threshold >= this.touchStartY ? (this.onSwipeDownAgent && this.onSwipeDownAgent(), "swiped down") : this.touchEndY === this.touchStartY ? (this.onTapAgent && this.onTapAgent(), "tap") : void 0 } }]), a }(); module.exports = Xwiper;
