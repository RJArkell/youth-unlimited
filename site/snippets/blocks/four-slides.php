<section>
  <div id="collapsetab" class="collapse">
    ...
    <div class="tab scrolling-wrapper-flexbox">
      <button class="card tablinks four" onclick="openTab(event, '<?= $data->slide1heading()->html() ?>')" id="defaultOpen"><?= $data->slide1heading()->html() ?></button>
      <button class="card tablinks four" onclick="openTab(event, '<?= $data->slide2heading()->html() ?>')"><?= $data->slide2heading()->html() ?></button>
      <button class="card tablinks four" onclick="openTab(event, '<?= $data->slide3heading()->html() ?>')"><?= $data->slide3heading()->html() ?></button>
      <button class="card tablinks four" onclick="openTab(event, '<?= $data->slide4heading()->html() ?>')"><?= $data->slide4heading()->html() ?></button>
    </div>
