...
<div class="searchpage">
  <a href="./home"><img class="smallcross" src="./assets/images/svgs/smallcross.svg"></a>
  <form class="searchbar">
    <input class="searchinput" type="search" name="q" value="<?= html($query) ?>">
    <input class="searchbutton" type="image" src="./assets/images/svgs/searchwhite.svg">
  </form>
